  ...
  if (botTrigger && botChatbox) {
    ...
    const handleSendMessage = (text) => {
      ...
      setTimeout(() => {
        ...
        if (q.includes('finpulse') || q.includes('hft') || q.includes('black-scholes') || q.includes('var') || q.includes('matching engine')) {
        ...
        } else if (q.includes('sentinel') || q.includes('ast') || q.includes('owasp') || q.includes('vulnerability') || q.includes('diff')) {
          ...
          botDiv.innerHTML = "🎓 <strong>AASTU Academic Portal</strong>: High-throughput university management system built with Go 1.22 REST APIs, React 18, PostgreSQL, ECTS weighted GPA calculator, JWT auth, and Docker containerization!<br/><br/><a href='https://github.com/yaya2127/aastu-academic-portal' target='_blank' style='color:#dfa951; font-weight:700;'>💻 View GitHub Repository</a>";
        } else if (q.includes('smart iot') || q.includes('environmental') || q.includes('dht22') || q.includes('mq-2')) {
          botDiv.innerHTML = "🔬 <strong>Smart IoT Environmental Monitor</strong>: Industrial telemetry system built with ATmega328P C++ firmware, DHT22 temperature/humidity & MQ-2 methane sensors, SVG circular gauges, and Proteus schematics!<br/><br/><a href='https://github.com/yaya2127/smart-iot-environmental-monitor' target='_blank' style='color:#dfa951; font-weight:700;'>💻 View GitHub Repository</a>";
        } else if (q.includes('ecommerce') || q.includes('storefront') || q.includes('shop') || q.includes('nestjs')) {
          botDiv.innerHTML = "🛒 <strong>Modern E-Commerce Storefront</strong>: Developer hardware storefront built with NestJS, TypeScript, Prisma ORM, live search, price sliders, promo code engine (TECH10), and cyber cart drawer!<br/><br/><a href='https://github.com/yaya2127/modern-ecommerce-storefront' target='_blank' style='color:#dfa951; font-weight:700;'>💻 View GitHub Repository</a>";
        } else if (q.includes('portfolio') && !q.includes('all')) {
          botDiv.innerHTML = "💼 <strong>Personal Developer Portfolio</strong>: Luxury dark/gold developer portfolio built with HTML5 Canvas particle background, glassmorphism UI, interactive project detail modals, CLI terminal, and AI Assistant!<br/><br/><a href='https://yaya2127.github.io/Personal-Portfolio/' target='_blank' style='color:#60a5fa; font-weight:700;'>🌐 Launch Live Portfolio</a>";
        } else if (q.includes('home') || q.includes('automation') || q.includes('optocoupler') || q.includes('relay')) {
          botDiv.innerHTML = "🏠 <strong>Microcontroller Home Automation</strong>: Bare-metal C hardware control system with optocoupler relay isolation, ADC LDR night sensing, and INT0 PIR motion interrupt routines!<br/><br/><a href='https://github.com/yaya2127/microcontroller-home-automation' target='_blank' style='color:#dfa951; font-weight:700;'>💻 View GitHub Repository</a>";
        } else if (q.includes('task') || q.includes('scheduler') || q.includes('kanban')) {
          botDiv.innerHTML = "📋 <strong>Interactive Task Scheduler</strong>: TaskMaster Pro Kanban web app built with React, TypeScript, 4-column status mover, LocalStorage persistence, and progress gauge!<br/><br/><a href='https://github.com/yaya2127/interactive-task-scheduler' target='_blank' style='color:#dfa951; font-weight:700;'>💻 View GitHub Repository</a>";
        } else if (q.includes('all projects') || q.includes('all 9') || q.includes('project list')) {
          botDiv.innerHTML = "🚀 <strong>Yared's 9 Completed Projects</strong>:<br/>1. 📈 FinPulse Engine (HFT & Risk Engine)<br/>2. ⚡ NexusIoT Edge (Industrial IoT Platform)<br/>3. 🛡️ SentinelAI (Agentic AI Security Auditor)<br/>4. 🎓 AASTU Academic Portal (Go Backend)<br/>5. 🔬 Smart IoT Environmental Monitor (C++ Firmware)<br/>6. 🛒 Modern E-Commerce Storefront (NestJS & Prisma)<br/>7. 💼 Personal Developer Portfolio (Luxury Dark UI)<br/>8. 🏠 Microcontroller Home Automation (Bare-Metal C)<br/>9. 📋 Interactive Task Scheduler (React Kanban)<br/><br/>You can ask me about any specific project or view them in the portfolio grid above!";
        ...
        } else if (q.includes('hire') || q.includes('job') || q.includes('work') || q.includes('role') || q.includes('available') || q.includes('intern') || q.includes('role')) {
